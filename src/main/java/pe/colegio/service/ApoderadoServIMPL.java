...
public class ApoderadoServIMPL implements ApoderadoServ{
	...
	public Collection<Apoderado> listar() {
...
//	//ELIMINAR Apoderado
//	@Override @Transactional
//	public void eliminar(Integer ApoderadoId) {
//		Apoderado Apoderado = buscarPorId(ApoderadoId);
//		repository.save(Apoderado);
//	}
	//FILTRAR by Curso, Nombre, Apellidos, Sexo o FechaRegistro 
//	@Override @Transactional(readOnly = true)
//	public Collection<Apoderado> filtrarByInfo(Curso curso, Apoderado Apoderado) {
//		String apellidos = Apoderado.getApellidoP() + " " + Apoderado.getApellidoM();
//		return repository.findByFiltrosCC(curso.getCursoId(), Apoderado.getNombres(), apellidos, Apoderado.getSexo().toString(),
//				Apoderado.getfRegistro(), curso.getNiv_educativo(), curso.getTurno());
//	}
}