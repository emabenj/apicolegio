...
<body>	
	...
	<div class="container-fluid">
		<c:choose>
			<c:when test="${rol}">
				<div class="row mb-3">				
					<a href="/bnnm/docentes/" class="col text-center">
						...
						<img src="/bnnm/imgs/docente.png" alt="LOGO DOCENTE" class="img-fluid w-50" >
					</a>
				...
				<div class="row">
					...
					<a href="/bnnm/cursos/" class="col-6 text-center">
						...
						<img src="/bnnm/imgs/cursos.png" alt="LOGO CURSOS" class="img-fluid w-50">
					</a>
					<div class="col"></div>
				</div>
			</c:when>
			<c:otherwise>
				<div class="row mb-3">				
					<a href="/bnnm/docentes/editar-perfil" class="col text-center">
