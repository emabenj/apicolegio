...
<body>
	...
	<div class="row justify-content-center">
		<form:form method="post" modelAttribute="docenteD">
		
			<div class="row mb-2">
			  <label class="form-control col-1 border-0 font-weight-bold">Código: </label>
			  <form:input type="text" path="docente_cod" cssClass="form-control col ml-5" readonly="true" tabindex="-1"/>
			  <div class="col-3"></div>
			</div>			
			
			<div class="row mb-2">
				<label class="form-control col-1 border-0 font-weight-bold">Docente: </label>
				<input type="text" value="${docenteD.nombres} ${docenteD.apellidoP} ${docenteD.apellidoM}" class="form-control col ml-5 p-2" readonly="readonly" tabindex="-1"/>
				<div class="col-1"></div>
			</div>
			<div class="row">
				<p class="text-primary">¿Estás seguro de que quieres eliminar a este docente?</p>
			</div>
